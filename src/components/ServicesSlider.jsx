      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {services.map((service) => (
            <div
              key={service.id}
              className="group bg-transparent rounded-lg transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl"
            >
              {/* Image */}
              ...
              {/* Card Content */}
              <div className="relative bg-white rounded-lg shadow-md mt-[-2.5rem] mx-6 py-8 px-4">
                {/* Gear Watermark */}
