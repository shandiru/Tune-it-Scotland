    ...
    <section className="relative bg-white py-24 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="relative inline-block mb-12">
          ...
          {/* Foreground Title */}
          <h2 className="relative text-3xl md:text-5xl font-extrabold text-[#2B2B2B] z-10">
            Why Choose Us
          </h2>
        </div>

        {/* Description */}
        <div className="text-[#555] max-w-3xl mx-auto leading-relaxed mb-14">
          <p className="mb-6">
            At <span className="font-semibold text-[#2B2B2B]">Tune It Scotland</span>, we don’t just tune cars — 
        ...
        {/* Call to Action */}
        <div className="bg-[#004B93] text-white py-8 px-10 rounded-lg inline-block mb-20 shadow-lg hover:bg-[#00376C] transition-all duration-300">
          <h3 className="text-xl md:text-2xl font-bold">
            Book Your Free Vehicle Health Check
          </h3>
          <p className="text-sm md:text-base mt-3 text-blue-100 max-w-lg mx-auto leading-relaxed">
